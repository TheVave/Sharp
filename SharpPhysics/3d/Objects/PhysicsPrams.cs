...
namespace SharpPhysics
{
	public struct PhysicsParams
	{
		...
		/// <summary>
		/// 3d direction using double[3]
		/// eg. SpeedDirection = new double { 10,0,10 }
		/// the object would go ten units in the x direction and 10 in the z direction
		/// </summary>
		public double[] SpeedDirection = new double[] { 0,0,0 };


		/// <summary>
		/// momentum
		/// </summary>
		public double[] Momentum = new double[] { 0, 0, 0 };
		...
		/// </summary>
		public float[] RotDirection = new float[] { 0, 0, 0 };

		internal PhysicsMeshStorage PhysicsMeshStorage = new PhysicsMeshStorage();

		public PhysicsParams() { }
		public PhysicsParams(float massToSet, SimulatedObject[] collidableObjects) 
		{ 
			Mass = massToSet; 
			CollidableObjects = collidableObjects; 
		}
		public PhysicsParams(float massToSet, float speed, double[] speedDirection, SimulatedObject[] collidableObjects)
		{
			Speed = speed;
			Mass = massToSet;
		...
		public PhysicsParams(float massToSet, float speed, double[] speedDirection, float[] rotDirection, SimulatedObject[] collidableObjects)
		{
			Speed = speed;
			Mass = massToSet;
			SpeedDirection = speedDirection;
