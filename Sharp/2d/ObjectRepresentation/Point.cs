...
namespace Sharp._2d.ObjectRepresentation
{
	public class Point : ISizeGettable, IAny
	{
		...
		/// </summary>
		public static readonly Point BlankPoint2d = new(0, 0);
		...
		public static bool HasNegative(Point pnt) =>
			(GenericMathUtils.IsNegative(pnt.X) || GenericMathUtils.IsNegative(pnt.Y) || GenericMathUtils.IsNegative(pnt.Z));
