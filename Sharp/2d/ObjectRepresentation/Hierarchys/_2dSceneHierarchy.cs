...
namespace Sharp._2d.ObjectRepresentation.Hierarchies
{
	...
	public class _2dSceneHierarchy : IAny
	{
		...
		public SimulatedObject2d[] Objects
		{
			...
			set
			{
				SetObjects(value, false);
			}
		}

		internal void SetObjects(SimulatedObject2d[] value, bool skip)
		{
			unsafe
			{
				if (!skip)
		...
		public short HierarchyId { get; private set; } = 0;

		public _2dSceneHierarchy()
		{
		}

		public _2dSceneHierarchy(SimulatedObject2d[] objects, short hierarchyId)
		{
			Objects = objects;
			HierarchyId = hierarchyId;
		}

		public static void RegisterObject(short hierarchyId, SimulatedObject2d obj)
		{
