...
unsafe
{
	...
	{
		MainRendererSGL.ObjectsToRender[1].objToSim.HeldObject.RegisterToScene();
		MainRendererSGL.ObjectsToRender[0].objToSim.HeldObject.RegisterToScene();
		MainRendererSGL.Camera.obj = new();
		MainRendererSGL.Camera.obj.RegisterToScene();
		MainRendererSGL.ObjectsToRender[0].objToSim.HeldObject.StartPhysicsSimulation();
		MainRendererSGL.ObjectsToRender[0].objToSim.HeldObject.ObjectPhysicsParams.SpeedResistance = 0.5;
		//MainRendererSGL.ObjectsToRender[1].objToSim.StartPhysicsSimulation();
		MainRendererSGL.ObjectsToRender[1].objToSim.HeldObject.ObjectPhysicsParams.SpeedResistance = 0.5;
		MainRendererSGL.ObjectsToRender[0].objToSim.HeldObject.ObjectPhysicsParams.sceneID = 0;
		MainRendererSGL.ObjectsToRender[1].objToSim.HeldObject.ObjectPhysicsParams.sceneID = 0;
